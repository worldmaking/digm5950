...
1. [**Introduction**](intro.html) *Sep 14* 
   ...
   - Action items:
     ...
     - Sign up for a free account with [Codepen](https://codepen.io/)
...
2. [**Cellular Automata II**](ca.html)
   - Sharing CA variants
     - [Nick's GridAlice](https://codepen.io/n1ckfg/pen/LYNJvGa?editors=0010), [Jonathan's Fractal 3](https://codepen.io/jonsil/pen/GRZwqJx?editors=0010), [Jonathan's Fractal 4](https://codepen.io/jonsil/pen/LYNXZpy?editors=0010) 
   - [Randomized gallery of assignments from past classes](https://artificialnature.net/courses/datt4950/gallery/index.html)
   - Today's scripts:
     - [Langton's Ant](https://codepen.io/grrrwaaa/pen/QWNJQxB?editors=0010)
     - [Langton's Ant: with colour](https://codepen.io/grrrwaaa/pen/GRZwdMK?editors=0010)
   - Action items:
...
- [Assignments: 40%](assignments.html). Exercises will assigned throughout the course. Exercises develop essential practice-informed critique and experiential learning. For each assessed exercise you will be asked to submit your code. Be sure to read & follow the instructions below regarding formatting.
  ...
  - Assignment videos: 20% (undergraduate students only). In addition please self-record a video that shows your desktop screen and captures your voice explaining your work. (In previous years we had students present their work to the group, but with the class size being so large we can't really afford the time to do this; hence videos.) These videos can be around 3 minutes each. The video should show the work and the code, and while recording your screen, please record your voice talking through the work. 
